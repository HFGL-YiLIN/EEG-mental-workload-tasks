function varargout = VS09(varargin)
% VS09 MATLAB code for VS09.fig
%      VS09, by itself, creates a new VS09 or raises the existing
%      singleton*.
%
%      H = VS09 returns the handle to a new VS09 or the handle to
%      the existing singleton*.
%
%      VS09('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VS09.M with the given input arguments.
%
%      VS09('Property','Value',...) creates a new VS09 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VS09_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to VS09_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help VS09
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @VS09_OpeningFcn, ...
                   'gui_OutputFcn',  @VS09_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before VS09 is made visible.
function VS09_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VS09 (see VARARGIN)

% Choose default command line output for VS09
...
% UIWAIT makes VS09 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = VS09_OutputFcn(hObject, eventdata, handles) 
...
subjno = get(handles.subjnumber, 'String');
global outfile
outfile = fopen([datafolder 'VS09_' num2str(subjno) '.csv'], 'w');
