function varargout = VS25(varargin)
% VS25 MATLAB code for VS25.fig
%      VS25, by itself, creates a new VS25 or raises the existing
%      singleton*.
%
%      H = VS25 returns the handle to a new VS25 or the handle to
%      the existing singleton*.
%
%      VS25('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VS25.M with the given input arguments.
%
%      VS25('Property','Value',...) creates a new VS25 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VS25_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to VS25_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help VS25
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @VS25_OpeningFcn, ...
                   'gui_OutputFcn',  @VS25_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before VS25 is made visible.
function VS25_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VS25 (see VARARGIN)

% Choose default command line output for VS25
...
% UIWAIT makes VS25 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = VS25_OutputFcn(hObject, eventdata, handles) 
...
subjno = get(handles.subjnumber, 'String');
global outfile
outfile = fopen([datafolder 'VS25_' num2str(subjno) '.csv'], 'w');
