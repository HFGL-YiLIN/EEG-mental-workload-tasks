function varargout = NBACK2(varargin)
% NBACK2 MATLAB code for NBACK2.fig
%      NBACK2, by itself, creates a new NBACK2 or raises the existing
%      singleton*.
%
%      H = NBACK2 returns the handle to a new NBACK2 or the handle to
%      the existing singleton*.
%
%      NBACK2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NBACK2.M with the given input arguments.
%
%      NBACK2('Property','Value',...) creates a new NBACK2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NBACK2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NBACK2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NBACK2
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @NBACK2_OpeningFcn, ...
                   'gui_OutputFcn',  @NBACK2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NBACK2 is made visible.
function NBACK2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NBACK2 (see VARARGIN)

% Choose default command line output for NBACK2
...
% UIWAIT makes NBACK2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = NBACK2_OutputFcn(hObject, eventdata, handles) 
...
subjno = get(handles.subjnumber, 'String');
global outfile
outfile = fopen([datafolder 'NBACK2_' num2str(subjno) '.csv'], 'w');
